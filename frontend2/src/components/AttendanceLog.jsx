...
if (card_id) params.card_id = card_id;
      ...
      const response = await axios.get("http://localhost:5000/attendance/get-attendance-logs", { params });
  ...
  const fetchMonthlyLogs = async () => {
    ...
    try {
      ...
      const response = await axios.get("http://localhost:5000/attendance/get-monthly-attendance", { params });
  ...
  const exportCsv = async () => {
    try {
      ...
      const response = await axios.get("http://localhost:5000/attendance/export-attendance-csv", {
